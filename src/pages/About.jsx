    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-20 md:py-24">
      <div className="max-w-4xl mx-auto space-y-10">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">About Inteliads</h1>
          <p className="text-sm md:text-base text-gray-400 max-w-2xl">
            Inteliads was created for authors who are tired of guessing their way through Amazon Ads. Our goal is simple: help serious KDP publishers protect their royalties and scale winning campaigns without turning into full‑time media buyers.
          </p>
        </header>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm md:text-base text-gray-300">
            At this stage we’re intentionally small and focused. The public beta lets us prove that Inteliads can reliably lower ACOS and save time before we open the doors wider.
          </p>
        </section>
