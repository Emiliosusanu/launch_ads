    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-20 md:py-24">
      <div className="max-w-5xl mx-auto space-y-10">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">What Inteliads actually does for you</h1>
          <p className="text-sm md:text-base text-gray-400 max-w-2xl">
            Under the hood, Inteliads is a collection of automation engines focused on a single outcome: more royalties from the same or lower ad spend.
          </p>
        </header>
