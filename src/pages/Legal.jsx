      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="space-y-3">
          ...
          <p className="text-sm md:text-base text-gray-400 max-w-2xl">
            This page collects links to the legal documents that govern your use of Inteliads during the beta.
          </p>
        </header>

        <section className="space-y-3 text-sm md:text-base text-gray-300">
          <p>
            By using Inteliads you agree to the following documents:
          </p>
        ...
        <section className="space-y-3 text-sm md:text-base text-gray-300">
          ...
          <p>
            ...
            <span className="font-medium"> legal@inteliads.pro</span>.
          </p>
        </section>
