    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm md:text-base text-gray-300 leading-relaxed">
          <p>
            These Terms of Use ("Terms") govern your access to and use of Inteliads, our platform that helps Amazon KDP authors monitor and optimize advertising campaigns.
          </p>

          <h2 className="text-xl font-semibold text-white mt-4">1. Beta service</h2>
          <p>
            Inteliads is currently offered as a beta product. Features may change, be added, or be removed at any time. The service is provided on an "as is" and "as available" basis.
          </p>
          ...
          <p>
            While Inteliads is designed to help optimise advertising, we do not guarantee specific results, sales, or performance. You remain responsible for your advertising decisions and compliance with Amazon’s policies.
          </p>

          <h2 className="text-xl font-semibold text-white mt-4">4. Limitation of liability</h2>
          <p>
            To the maximum extent permitted by law, Inteliads will not be liable for any indirect, incidental, or consequential damages, or any loss of profits or revenue arising from your use of the service.
          </p>
          ...
          <p>
            ...
            <span className="font-medium"> support@inteliads.pro</span>.
          </p>
