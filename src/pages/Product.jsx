    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-20 md:py-24">
      <div className="max-w-5xl mx-auto space-y-12">
        <header>
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Inteliads for Amazon KDP authors</h1>
          <p className="text-sm md:text-base text-gray-400 max-w-2xl">
            Inteliads is an automation layer on top of Amazon Ads, built specifically for self‑publishers. It helps you keep ACOS under control, protect against wasted spend, and scale winning campaigns without living inside spreadsheets.
          </p>
        </header>
        ...
        <section className="space-y-4 bg-[#111118] border border-white/10 rounded-2xl p-5 md:p-8">
          ...
          <p className="text-sm md:text-base text-gray-300">
            Built for authors who are tired of spending hours inside the ads dashboard. Inteliads helps you understand what’s happening, stay in control, and manage your campaigns with confidence&nbsp;— without the stress and overwhelm.
          </p>
        ...
        <section className="space-y-3">
          ...
          <ol className="space-y-2 text-sm md:text-base text-gray-300 list-decimal list-inside">
            <li>You connect your Amazon Ads account to Inteliads.</li>
