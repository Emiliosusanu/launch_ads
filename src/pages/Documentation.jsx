            ...
            <main className="container mx-auto max-w-4xl px-6 py-12">
                ...
                >
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">Everything you need to know about how Inteliads works and how your automation flow is structured.</p>
                    </div>
                    ...
                    <div className="bg-[#16161a] border border-white/5 rounded-2xl p-8 md:p-12 shadow-2xl space-y-12">
                        ...
                        <DocSection title="Security &amp; Privacy" icon={Shield}>
                            <p>We take your data seriously. Inteliads uses the official Amazon Advertising API and never stores your Amazon login credentials.</p>
