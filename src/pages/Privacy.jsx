    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm md:text-base text-gray-300 leading-relaxed">
          <p>
            Inteliads ("we", "our", or "us") provides tools to help Amazon KDP authors monitor and optimize their advertising campaigns. This policy explains how we handle data when you use our website and dashboard.
          </p>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>Provide and maintain the Inteliads service.</li>
