    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F3F3F4] px-6 py-20 md:py-24">
      <div className="max-w-4xl mx-auto space-y-10">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">Work with Inteliads</h1>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm md:text-base text-gray-300">
            ...
            <span className="font-medium"> jobs@inteliads.pro</span>. We read every message, even if we can’t reply to all of them.
          </p>
        </section>
